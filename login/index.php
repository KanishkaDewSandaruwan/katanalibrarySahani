...
<html lang="en">
<head>
	<title>Sign In -KATANA LIBRARY</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form border border-round" method="POST">
					<span class="login100-form-title p-b-33">
						Library Account Login
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input required class="input100" type="text" name="uname" placeholder="Username">
