...
<body>
  ...
  <div class="gallery-box p-5 mt-5">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <!-- <div class="heading-title text-center"> -->
            <h2 style="font-size: 50px; text-align: left; color: maroon "><b><?php echo $row2['cat_name']; ?></b><h2>
            <hr>
          <!-- </div> -->
        </div>
      </div>
  ...
  <div class="gallery-box p-5 mt-5">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <!-- <div class="heading-title text-center"> -->
            <h2 style="font-size: 50px; text-align: left; color: maroon"><b><?php echo $row2['author_name']; ?></b><h2>
            <hr>
          <!-- </div> -->
        </div>
      </div>
  ...
  <div class="gallery-box p-5 mt-5">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <!-- <div class="heading-title text-center"> -->
            <h2 style="font-size: 50px; text-align: left; color: maroon"><b>BOOKS</b><h2>
            <hr>
          <!-- </div> -->
        </div>
      </div>
